...
copy(originalFlavors, flavorsCopy);
...
function flavorSearch(arr, string){
    let newArr = [];
...
console.log(flavorSearch(originalFlavors,"Chocolate"));
...
function getRandomFlavors(arr1, arr2, arr3, arr4){
    ...
    for(i = 0; i < 31; i++){
        let rand = Math.floor(Math.random() * allFlavors.length);
        randomFlavors.push(allFlavors[rand]);
